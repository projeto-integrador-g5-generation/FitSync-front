    ...
    return (
      <div className="relative w-full">
        ...
        <button
          ...
          className="absolute left-3 top-1/2 transform -translate-y-1/2 bg-cyan-600 text-white p-2 rounded-full hover:bg-cyan-500 active:scale-95 transition duration-200 ease-in-out flex items-center justify-center w-12 h-12"
            >
              <FaArrowLeft size={20} />
            </button>
        ...
        <div className="flex transition-transform duration-500 ease-in-out w-full gap-x-4 overflow-hidden">
          {membros
            ...
            <button
                onClick={handleNext}
                className="absolute right-3 top-1/2 transform -translate-y-1/2 bg-cyan-600 text-white p-2 rounded-full hover:bg-cyan-500 active:scale-95 transition duration-200 ease-in-out flex items-center justify-center w-12 h-12"
            >
